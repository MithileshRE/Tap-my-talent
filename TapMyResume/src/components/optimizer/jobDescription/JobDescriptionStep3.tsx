...
import { getMasterEdu } from '../../../services/userDetailsService';
  ...
  useEffect(() => {
    ...
    const processOptimizedResume = async () => {
      try {
        ...
        // Fetch education and certification data to merge with resume data
        setLoadingMessage('Fetching education and certification data...');
        let educationData;
        try {
          educationData = await getMasterEdu(userEmail);
        } catch (eduError) {
        ...
        // Merge resume data with education and certification data
        // Convert keys to lowercase as required
        ...
        // For uploaded resume path: use merged resume_data from final builder + education data
        ...
        console.log('Generate params:', generateParams);
        ...
        try {
          ...
          setDownloadUrl("https://core.tapmytalent.com/resumeBuilder-Dev" + generateResponse.pdf.download_url);
          updateResumeData({
            download_url: "https://core.tapmytalent.com/resumeBuilder-Dev" + generateResponse.pdf.download_url
          });
        } catch (generateError) {
