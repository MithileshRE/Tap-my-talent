  ...
  return (
    ...
    backgroundPosition: 'center',
        ...
        <div className="home-hero-section-features">
          <span className="home-hero-section-feature"> <span><img src={TickVector} alt="Tick Vector" /></span> Résumé Optimization</span>
        ...
        <button className="home-hero-section-cta-button">Sign Up for Free</button>
      </div>
